...
issues_url 'https://github.com/Dwolla/osquery-cookbook/issues' if respond_to?(:issues_url)
source_url 'https://github.com/Dwolla/osquery-cookbook' if respond_to?(:source_url)
